            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 p-3">
                       ...
                       <div data-aos="fade-left"> <button className='btn btn-outline-info rounded-4 mt-5 mx-lg-0 mx-auto d-flex' onClick={() => {window.location.href = "https://www.linkedin.com/in/suraj-anand-/"}}>Know More</button> </div>
                    </div>
