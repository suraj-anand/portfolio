        ...
        <section id="skills">
            <div className="container text-white">
              ...
              <div className="my-4">
                ...
                <div data-aos="fade-left"  data-aos-duration="1000" className='my-0 h-line-1'></div>
              </div>
